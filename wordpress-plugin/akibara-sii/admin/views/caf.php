        ...
        if ($caf_data) {
            ...
            if ($existe) {
                ...
                if ($inserted) {
                    ...
                    echo '<div class="notice notice-error"><p>Error al guardar el CAF en la base de datos.</p>';
                    if ($db_error) {
                        echo '<p><strong>Error MySQL:</strong> ' . esc_html($db_error) . '</p>';
                    }
                    echo '<p><em>Solución: Desactiva y reactiva el plugin para recrear las tablas.</em></p></div>';
                }
            }
        } else {
